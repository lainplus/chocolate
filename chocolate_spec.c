...
int set_options_01() {
	int argv_offset;
	char *argv[] = { "chocolate", "ruby", "test1.rb", NULL };
...
int set_options_02() {
	int argv_offset;
	char *argv[] = { "chocolate", "-r", "ruby", "test2.rb", NULL };
...
int set_options_03() {
	int argv_offset;
	char *argv[] = { "chocolate", "-c", "ruby", "test3.rb", NULL };
...
int set_options_04() {
	int argv_offset;
	char *argv[] = { "chocolate", "-d", "ruby", "test4.rb", NULL };
...
int set_options_05() {
	int argv_offset;
	char *argv[] = { "chocolate", "ls", "-r", "-c", NULL };
...
int set_options_06() {
	int argv_offset;
	char *argv[] = { "chocolate", "-s", "make test", NULL };
...
/*
 * All commands must be formatted as a single argument when run in a shell
 */
int set_options_07() {
	int argv_offset;
	char *argv[] = { "chocolate", "-s", "make", "test", NULL };
